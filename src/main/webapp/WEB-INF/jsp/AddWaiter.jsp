...
<body>
    ...
    <form action="Add_Waiter" method="post" enctype="multipart/form-data">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="position" name="position" value="พนักงานเสิร์ฟ" readonly required>
        </div>
