...
<body>
      ...
      <form action="LoginManager" method="post" id="loginForm">
        ...
        <div class="form-group">
          ...
          <div class="input-wrapper">
            <input type="text" class="form-control" id="usernameInput" name="username" required placeholder="กรอกชื่อผู้ใช้ (เริ่มต้นด้วย manager)">
            <i class="fas fa-user input-icon"></i>
          </div>
          <div class="error-message" id="usernameError">ชื่อผู้ใช้ต้องขึ้นต้นด้วย manager เท่านั้น</div>
        </div>
        
        <div class="form-group">
          <label class="form-label">รหัสผ่าน</label>
          <div class="input-wrapper">
            <input type="password" class="form-control" id="passwordInput" name="password" required placeholder="กรอกรหัสผ่าน (ตัวอักษร + ตัวเลข, 8 ตัวขึ้นไป)">
            <i class="fas fa-lock input-icon"></i>
          </div>
          <div class="error-message" id="passwordError">รหัสผ่านต้องมีตัวอักษร + ตัวเลข รวมกัน 8 ตัวขึ้นไป</div>
        </div>
  ...
  <script>
    ...
    function validateUsername(username) {
      return username.toLowerCase().startsWith('manager');
    }
    ...
    const inputs2 = document.querySelectorAll('.form-control');
