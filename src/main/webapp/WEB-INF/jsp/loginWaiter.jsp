...
<head>
  ...
  <style>
    ...
    * {
    ...
    .role-button.active {
      background: linear-gradient(135deg, var(--waiter-accent) 0%, #9f88c5 100%);
      color: var(--white);
      border-color: var(--waiter-accent);
      border-width: 3px;
      box-shadow: 0 8px 20px -8px rgba(139, 125, 184, 0.3);
    }
    ...
    .form-control:focus {
      border-color: var(--waiter-accent);
      border-width: 3px;
      box-shadow: 0 0 0 3px rgba(139, 125, 184, 0.08);
    ...
    .btn-login:hover {
      transform: translateY(-1px);
      box-shadow: 0 8px 20px -6px rgba(139, 125, 184, 0.35);
      background: linear-gradient(135deg, #7a6fa5 0%, #8b7db8 100%);
      border-color: #6b5f8a;
    }
    ...
    .main-container::after {
      ...
      right: -3px;
      bottom: -3px;
      background: linear-gradient(135deg, rgba(139, 125, 184, 0.08), rgba(159, 136, 197, 0.04));
      border-radius: 23px;
      z-index: -1;
      opacity: 0;
  ...
  <div class="main-container">
    <div class="roles-section">
      ...
      <div class="roles-grid">
        ...
        <form action="RoleWaiter" method="post">
          <button type="submit" class="role-button waiter active">
    ...
    <div class="login-section">
      <div class="login-header">
        <h2>เข้าสู่ระบบพนักงานเสิร์ฟ</h2>
